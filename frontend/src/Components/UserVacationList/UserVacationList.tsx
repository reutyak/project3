...
function UserVacationList(): JSX.Element {
    ...
    // },[vacations]);
    const myUserName:any=localStorage.getItem('id')!==null&&localStorage.getItem('id')!==undefined?localStorage.getItem('id'):0;
    ...
    //const itemsPerPage=10;
        useEffect(()=>{      
            ...
            //     setUsers(response.data);})
                axios.get(`http://localhost:3003/user/single/${+myUserName}`)
        ...
        const sortedVacations=userVacationsList.sort((objA,objB)=>new Date(objB.start_date).getTime()-new Date(objA.start_date).getTime());
        // Get currCards
